...
RUN apt-get update && apt-get install -y \
    ...
    libflite1 libflite-dev libflite1-dev libopus0 libvpx7 libx264-dev libwoff1 \
    libenchant-2-2 libsecret-1-0 libhyphen0 libmanette-0.2-0 libavif15 harfbuzz-icu \
